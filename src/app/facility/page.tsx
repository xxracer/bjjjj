    ...
    return (
        <div className="container mx-auto max-w-6xl px-4 py-12 md:py-24">
            <div className="text-center mb-12">
                <h1 className="text-4xl font-bold font-headline tracking-tighter sm:text-5xl">Our State-of-the-Art Facility</h1>
            ...
            <div className="grid grid-cols-2 gap-2 mb-12">
                {facilityImages.map((image) => (
                     <div key={image.id} className="relative aspect-w-16 aspect-h-9 rounded-lg overflow-hidden shadow-lg">
                        <Image
                            src={image.imageUrl}
